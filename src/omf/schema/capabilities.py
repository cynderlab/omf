"""Frozen capability payloads.

Firewall vendors share these types. A vendor implements only the names its
catalog needs; this is not a global CORE that every future vendor must fill.
"""
